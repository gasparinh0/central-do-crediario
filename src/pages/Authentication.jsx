...
export default function Authentication() {
  ...
  const handleBackToLogin = () => {
    setIsRegistering(false); // Volta ao componente de login
  };

  return (
    <div className={`${isDarkMode ? 'bg-login-background-dark' : 'bg-login-background-white'} bg-left-bottom bg-cover`}>
      {!isRegistering ? (
        !isForgetPassword ? (
